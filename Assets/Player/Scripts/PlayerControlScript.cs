...
public class PlayerControlScript : MonoBehaviour
{
    ...
    // used in determing how quickly to turn the player in relation to looking at the cursor
    float playerTurnVariable = 0;
    Vector3 playerTurnMousePosCache;
    Quaternion playerTurnRotationCache;
